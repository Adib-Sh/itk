...
datapath = "../../data/GroupE/" 
#filename = "BNL-PPB2-MLS-220_cold_unshunted.txt"
#filename = "BNL-PPB2-MLS-221.txt"
filename = sys.argv[1]
...
for hybridnum in range(0,len(cold_hybrids)):
    ...
    chipmean.append([hybridnum,cold_hybrids[hybridnum].temperature])
...
fig = plotRCClassified(cold_hybrids[74], variable="innse", showStream0=read_stream0, showStream1=read_stream1)
