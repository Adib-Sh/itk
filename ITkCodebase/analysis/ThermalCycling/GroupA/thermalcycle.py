...
#restart after 6 cycles
#datapath = "../../../data/ThermalCycle_Feb28_LS_013-016/results/" 
#filename = "GPC2150_X_014_C_H1.json"
#filename = "GPC2149_X_002_C_H0.json"
#filename = "GPC2149_X_002_C_H4.json"
#filename = "GPC2149_X_002_C_H5.json"


#restart after 3 cycles
datapath = "../../../data/ThermalCycle_March6_LS_019-022/results/"
#filename = "GPC2150_X_017_A_H2.json"
#filename = "GPC2150_X_017_A_H1.json"
#filename = "GPC2150_X_017_A_H0.json"
filename = "GPC2150_X_014_C_H6.json"
#filename = "scrambleddata.json"
...
for f in list(filelist["warm_filenames_nominal"]):
    print(datapath+f)
    warm_hybrids.append(parseTxtRC(datapath+f, readstream0=read_stream0, readstream1=read_stream1))

print("Parsing cold modules")
cold_hybrids = []

for f in list(filelist["cold_filenames_nominal"]):
...
#plt.scatter([x[0] for x in chipmean if x[2] == 5], [x[1] for x in chipmean if x[2] == 5], label="Cold")
...
plt.vlines(2.5, 0,2000, color="grey", linestyles="--", label="Restart")
